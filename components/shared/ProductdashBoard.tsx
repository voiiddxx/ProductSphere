...
import { Box, CalendarRangeIcon, ChevronDown, Dot, File, Filter, Flame, ListFilter, ListTodo, LucideWorkflow, MoreVertical, Network, Search, Settings, User } from "lucide-react";
    ...
    <div className="h-screen w-full flex bg-zinc-50">
      ...
      <div className="h-screen w-full">
        ...
        <div className="w-full px-10  gap-2 mt-5" >
         ...
         {
            tasks.map((curr:any)=>{
              return <div className="h-[300px] w-[400px] bg-white border rounded-md px-4 py-2 flex flex-col justify-between" >
                {/* task upper title and status part */}
                <div>
                <div className="flex w-full justify-between  items-center mt-2" >
                  <p className="text-zinc-700 text-sm font-semibold" >Data Enhancement</p>
                 <div className="flex gap-2" >
                 <div className="px-[7px] py-[2px] bg-yellow-50 rounded-full flex items-center justify-center text-yellow-600" >
                  <Flame size={12} strokeWidth={2} />
                  <p className="text-[10px] font-medium text-yellow-500" >High Priority</p>
                  </div>
                  <div className="px-[7px] py-[2px] bg-red-50 rounded-full" >
                  <p className="text-[10px] font-medium text-red-500" >Pending</p>
                  </div>
                 </div>
                </div>

                <div>
                  <p className="text-xs mt-4 mr-10 text-zinc-500" >Enhance the data refreshment technique and boost the api request hitting time to reduce effort</p>
                </div>
                ...
                <div className="w-full flex justify-between mt-4" >
                  <div className=" flex items-center gap-2" >
                    <div className="h-6 w-6 rounded-full bg-indigo-700 flex justify-center items-center" >
                    </div>
                    <p className="text-xs font-medium text-zinc-500" >Created by Nikhil</p>
                  </div>
